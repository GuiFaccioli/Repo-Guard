...
- [ ] T6 — Integração frontend total para render didático completo por check.
- [ ] T7 — Hardening final + rollout/rollback documentado.
...
- Integração frontend completa dos 4 campos didáticos por check ainda pendente (fase seguinte).

## Remaining tasks
- T6: Consumir `didacticChecks` no frontend como fonte principal de render.
- T7: Completar plano de rollout/rollback e reforçar testes de regressão contextual.

## Workload / PR boundary
- Estratégia aprovada: **single PR com size exception**.
- Boundary desta entrega: backend-first com contrato novo + testes unitários iniciais.
